...
Route::group(['middleware' => 'authority.checkpost'], function () {
    ...
    Route::group([
        ...
        Route::delete('delete-single-inventory', [
            'as'    => 'delete.single.inventory',
            'uses'  => 'InventoryController@deleteSingleInventory'
        ]);

        Route::delete('delete-product-inventory', [
            'as'    => 'delete.product.inventory',
            'uses'  => 'InventoryController@deleteProductInventory'
        ]);

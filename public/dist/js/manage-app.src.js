...
(function (window, angular, undefined) {
    ...
    angular
        ...
        .controller('InventoryListController', [
            ...
            '__Utils',
            'appNotify',
            function ($scope, __DataStore, __Form, $stateParams, appServices, InventoryDataService, __Utils, appNotify) {
                ...
                scope.deleteSingleInventory = function (combinationId, locationId, supplierId) {
                    swal2.fire({
                        title: 'Are you sure?',
                        ...
                        if (result.value) {
                            return __DataStore.post('delete.single.inventory', {
                                _method: 'DELETE',
                                combinationId, locationId, supplierId
                            }, {})
                                .success(function (responseData) {
                                    let response = responseData.data;
                                    appNotify[(response.incident ? 'error' : 'success')](response.message);

                                    if (!response.incident)
                                        scope.getInventories(null);

                                }).error(function () {
                                    appNotify.error('Something went wrong! Please try again.');
                                });
                        }
                    });
                }

                scope.deleteProductInventory = function (productId) {
                    swal2.fire({
                        title: 'Are you sure?',
                        text: "You want to delete all inventories of this product?",
                        type: 'warning',
                        showCancelButton: true,
                        confirmButtonText: 'Yes, delete it!',
                        cancelButtonText: 'No, cancel!',
                        ...
                        if (result.value) {
                            return __DataStore.post('delete.product.inventory', {
                                _method: 'DELETE',
                                productId
                            }, {})
                                .success(function (responseData) {
                ...
                scope.getReports = function () {
                    ...
                    scope.reportDataTable = __DataStore.dataTable('#lwreportList', {
                        ...
                        dtOptions: {
                            ...
                            "pageLength": 25,
                            'columnDefs': [
                                {class: 'text-right', targets: [4, 5, 6, 8]},
                                {
                                    "targets": [6, 7],

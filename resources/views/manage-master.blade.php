    ...
    <noscript>
        ...
        <div class="custom-noscript">
            <div class="bs-callout bs-callout-danger nojs-msg">
                ...
                <em><strong><?= __tr('Javascript') ?></strong> <?= __tr('is disabled in your browser, To use this application please enable javascript &amp; reload page again.') ?>
                </em>
            </div>
        </div>
    </noscript>
...
@if(isDemo())
    ...
    <div class="lw-main-wrapper">
        ...
        <div class="lw-main-page-container" ng-class="{'lw-no-sidebar': !manageCtrl.isLoggedIn()}">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <button type="button" class="btn btn-light bg-white border lw-sidebar-collapse"
                        ng-show="manageCtrl.isLoggedIn()">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav ml-auto lw-top-menu">
                        ...
                        <li ui-sref-active="active" class="nav-item" ng-show="!manageCtrl.isLoggedIn()">
                            <a class="nav-link lw-top-menu-link" title="<?= __tr('Login') ?>"
                               ui-sref="login"><?= __tr('Login') ?></a>
                        </li>
                        <li ui-sref-active="active" class="nav-item" ng-show="manageCtrl.isLoggedIn()">
                            <a class="nav-link lw-top-menu-link" title="<?=  __tr('Dashboard')  ?>" ui-sref="dashboard"><i
                                        class="fa fa-tachometer" aria-hidden="true"></i> <?= __tr('Dashboard') ?></a>
                        </li>

                        <li ui-sref-active="active" class="nav-item"
                            ng-show="manageCtrl.isLoggedIn() && canAccess('manage.billing.write.store_bill')">
                            <a class="nav-link lw-top-menu-link" title="<?=  __tr('Add New Bill')  ?>"
                               ui-sref="billing_add"><i class="fa fa-plus"
                                                        aria-hidden="true"></i> <?= __tr('Add New Bill') ?></a>
                        </li>
                        <li ui-sref-active="active" class="nav-item" ng-show="manageCtrl.isLoggedIn()">
                            <a class="nav-link lw-top-menu-link" ui-sref-active="active"
                               ng-show="canAccess('manage.inventory.read.list')" title="<?=  __tr('Inventory')  ?>"
                               ui-sref="inventory"><i class="fa fa-list-alt"
                                                      aria-hidden="true"></i> <?= __tr('Inventory') ?></a>
                        </li>

                        <li class="nav-item dropdown" ng-show="manageCtrl.isLoggedIn()">
                            <a class="nav-link dropdown-toggle lw-top-menu-link" href="" id="navbarDropdown"
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" ui-sref-active="active" ui-sref="profile"
                                   title="<?=  __tr('Profile')  ?>"><?=  __tr('Profile')  ?></a>
                                <a class="dropdown-item" ui-sref-active="active" ui-sref="changePassword"
                                   title="<?= __tr('Change Password') ?>"><?= __tr('Change Password') ?></a>
    ...
    @push("appScripts")
        <?= __yesset('dist/js/manage-app.src.js', true) ?>
    @endpush

<!-- settings update reload button template -->
    <script type="text/ng-template"
            id="lw-settings-update-reload-button-template.html">
        <input type="hidden" id="lwReloadBtnText"
               data-message="<i class='fa fa-refresh' aria-hidden='true'></i> <?= __tr("Reload") ?>">
    </script>
    <!-- /settings update reload button template -->
    ...
    <footer class="lw-footer hide-till-load container-fluid">
        <span class="text-muted">
                ...
                <span class="pull-right">
                        <span> Powered by <strong>Inventario <small><?= config('lwSystem.version') ?></small></strong>   |  Designed &amp; Developed by <a
                                    href="http://livelyworks.net" title="Design &amp; Developed by LivelyWorks"
                                    target="_blank">LivelyWorks</a></span>
                    </span>
            @endif
            </span>
    </footer>

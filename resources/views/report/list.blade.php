...
<div>
    ...
    <form class="lw-form lw-ng-form lw-ng-form"
        name="reportListCtrl.[[ reportListCtrl.ngFormName ]]"
        novalidate>
        ...
        <div class="form-row">
            ...
            <div class="col-md-4">
                ...
                <lw-form-field field-for="duration" label="<?= __tr( 'Duration' ) ?>" advance="true">
                    <select class="lw-form-field form-control"
                        name="duration" ng-model="reportListCtrl.duration" ng-options="role as key for (role, key) in reportListCtrl.durations" ng-required="true" ng-change="reportListCtrl.durationChange(reportListCtrl.duration)">
                    </select>
                </lw-form-field>
                <!-- /duration -->
            </div>
            ...
            <div class="col-md-4">
                ...
                <lw-form-field field-for="start" label="<?= __tr( 'Start Date' ) ?>">
                    <input type="text"
                            ...
                            options="[[ reportListCtrl.startDateConfig ]]"
                            readonly
            ...
            <div class="col-md-4">
                ...
                <lw-form-field field-for="end" label="<?= __tr( 'End Date' ) ?>">
                    <input type="text"
                        ...
                        options="[[ reportListCtrl.endDateConfig ]]"
                        ng-required="true"
                        readonly
            ...
            <div class="col-md-4">
                ...
                <lw-form-field field-for="order" label="<?= __tr( 'Type' ) ?>">
                    <select class="lw-form-field form-control"
                        name="order" ng-model="reportListCtrl.reportData.stock_subtype" ng-options="role as key for (role, key) in reportListCtrl.stock_subtype" ng-required="true">
                    </select>
                </lw-form-field>
            ...
            <div class="col-md-4">
                ...
                <lw-form-selectize-field field-for="locations" label="<?= __tr( 'Locations' ) ?>" class="lw-selectize">
                    <selectize config='reportListCtrl.locationsSelectConfig'
                        class=" form-control lw-form-field"
                        name="locations"
                        ng-model="reportListCtrl.reportData.locations"
                        options='reportListCtrl.locations'
                        placeholder="<?= __tr( 'Select Locations' ) ?>">
                    </selectize>
            ...
            <div class="col-md-4">
                ...
                <button type="submit" ng-click="reportListCtrl.getReports()" class="btn btn-primary lw-btn lw-form-row-btn" title="<?= __tr('Show') ?>"><?= __tr('Show') ?></button>
    ...
    <div class="card mb-2">
        <div class="card-body">
            <div><?= __tr('Showing __type__ Report for', [
    ...
    <div>
        ...
        <input type="hidden" id="lwReportInput"
            data-filename="<?= __tr( "__filename__ Report") ?>"
            data-top-message="<?= __tr( 'Duration : __start__ - __end__') ?>"
        ...
        <table class="table table-striped table-bordered"
            ...
            <thead>
                <tr>
                    <th><?= __tr('SKU') ?></th>
                    <th><?= __tr('Product Combinations') ?></th>
                    <th><?= __tr('Location') ?></th>
                    <th><?= __tr('Created At') ?></th>
                    <th><?= __tr('Qty') ?></th>
                    <th><?= __tr('Price') ?></th>
                    <th><?= __tr('Product Total') ?></th>
                    <th><?= __tr('Tax') ?></th>
                    <th><?= __tr('Amount') ?></th>
                </tr>
            </thead>

...
<div>
    <div class="lw-section-heading-block">
        ...
        <div class="lw-section-right-content">
            <a href title="<?= __tr('Add New Location / Warehouse') ?>" ng-show="canAccess('manage.location.write.create')" class="lw-btn btn btn-sm btn-primary float-right" ng-click="locationListCtrl.openAddDialog()">
            <i class="fa fa-plus"></i> <?= __tr('Add New Location / Warehouse') ?> </a>
        </div>
        <!--/ button -->
    ...
    <table class="table table-striped table-bordered" id="lwlocationList" class="ui celled table" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th><?= __tr('Name') ?></th>
                <th><?= __tr('Location Id') ?></th>
                <th><?= __tr('Status') ?></th>

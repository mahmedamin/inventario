...
<div>
    ...
    <div class="col-md-8 col-xs-12 offset-md-2 lw-login-form-box shadow p-4 border">
        ...
        <!--  main heading  -->
            ...
            <div class="lw-heading"><?=  __tr( 'General Settings' )  ?></div></h3>
        <!--  /main heading  -->
    </div>
    ...
    <input type="hidden" id="lwGeneralSettingTxtMsg" loading-text="<?= __tr( 'Upload in Process') ?>" logo-empty-file-text="<?= __tr('Only PNG images are expected') ?>" file-uploaded-text="<?= __tr('File Uploaded') ?>">

     <!--  form action  -->
    <form class="lw-form lw-ng-form" name="generalCtrl.[[ generalCtrl.ngFormName ]]" 
    ng-submit="generalCtrl.submit()" 
    novalidate>
        ...
        <lw-form-field field-for="name" label="<?= __tr( 'Website Name' ) ?>"> 
            <input type="text" 
                  ...
                  min="2"
                  max="30" 
                  ng-model="generalCtrl.editData.name" />
        </lw-form-field>
        <!-- Name -->
        ...
        <div class="form-group">
            <fieldset class="lw-fieldset-2">
                ...
                <div class="alert alert-info mt-2">
                    <strong>Note : </strong>Recomended height for Logo is 50 pixels.
                </div>

                <div class="form-row">
                    <div class="col-md-6">
                        <!-- New Favicon image -->
                        <lw-form-selectize-field field-for="favicon_image" label="<?= __tr( 'New Favicon' ) ?>" class="lw-selectize"><span class="badge lw-badge">[[ generalCtrl.faviconFilesCount ]]</span>
                            <selectize config='generalCtrl.imagesSelectConfig' class="lw-form-field" name="favicon_image" ng-model="generalCtrl.editData.favicon_image" options='generalCtrl.faviconFiles' placeholder="<?= __tr( 'Only ICO images are allowed' ) ?>" ></selectize>
                    ...
                    <div class="col-md-6">
                        ...
                        <lw-form-selectize-field field-for="small_logo_image" label="<?= __tr( 'New Small Logo' ) ?>" class="lw-selectize"><span class="badge badge-success lw-badge">[[ generalCtrl.logoFilesCount ]]</span>
                            <selectize config='generalCtrl.imagesSelectConfig' class="lw-form-field" name="small_logo_image" ng-change="generalCtrl.checkLogo(2)" ng-model="generalCtrl.editData.small_logo_image" options='generalCtrl.logoFiles' placeholder="<?= __tr( 'Only PNG images are allowed' ) ?>" ></selectize>
                        </lw-form-selectize-field>
                         <!-- New Small Logo image -->
                     </div>
                    ...
                    <div class="col-md-12">
                        <!-- New Logo image -->
                        <lw-form-selectize-field field-for="logo_image" label="<?= __tr( 'New Logo' ) ?>" class="lw-selectize"><span class="badge lw-badge">[[ generalCtrl.logoFilesCount ]]</span>
                            <selectize config='generalCtrl.imagesSelectConfig' class="lw-form-field" name="logo_image" ng-change="generalCtrl.checkLogo(1)" ng-model="generalCtrl.editData.logo_image" options='generalCtrl.logoFiles' placeholder="<?= __tr( 'Only PNG images are allowed' ) ?>" ></selectize>
        ...
        <div class="form-row">
            <div class="col">
                ...
                <lw-form-field field-for="timezone" label="<?= __tr( 'Timezone' ) ?>"> 
                    <selectize config='generalCtrl.timezone_select_config' class="lw-form-field" name="timezone" ng-model="generalCtrl.editData.timezone" options='generalCtrl.timezoneData' placeholder="<?= __tr( 'Timezone' ) ?>" ng-required="true"></selectize>
                </lw-form-field>
                <!-- /timezone -->
            </div>
            ...
            <div class="col">
                <!-- System Email -->
                <lw-form-field field-for="business_email" title="<?= __tr('Will be used for the from email.') ?>" label="<?= __tr( 'System Email' ) ?>"> 
                    <input type="email" 
                          class="lw-form-field form-control"
                          name="business_email"
                          ng-required="true" 
        ...
        <fieldset class="lw-fieldset-2">
            ...
            <lw-form-checkbox-field field-for="enable_login_attempt" label="<?= __tr( 'Enable Login attempts' ) ?>" advance="true">
                <input type="checkbox" 
                    class="lw-form-field js-switch"
                    name="enable_login_attempt"
                    ng-model="generalCtrl.editData.enable_login_attempt"
                    ui-switch="" />
            ...
            <div class="form-inline" ng-if="generalCtrl.editData.enable_login_attempt == true">
                <div class="form-group">
                    <label for="show_captcha"><?= __tr('Show captcha after') ?></label>

                    <!-- Show Captcha after login attempt -->
                    <lw-form-field field-for="show_captcha" v-label="<?= __tr( 'Show Captcha' ) ?>">
                        <input type="number"
                            class="lw-form-field form-control form-control mx-sm-3 mt-4"
                            autofocus
                            name="show_captcha"
                            ng-required="true"
                            min="1"
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <lw-form-field field-for="recaptcha_site_key" label="<?= __tr( 'Google Recaptcha Site Key' ) ?>" ng-if="generalCtrl.editData.enable_login_attempt == true"> 
                        <input type="text" 
                              class="lw-form-field form-control"
                              name="recaptcha_site_key"
                              ng-required="true" 
                              ng-model="generalCtrl.editData.recaptcha_site_key" />
                    </lw-form-field>
                    <!-- Google Recaptcha Site Key -->
                </div>
                ...
                <div class="col">
                    ...
                    <lw-form-field field-for="recaptcha_secret_key" label="<?= __tr( 'Google Recaptcha Secret Key' ) ?>" ng-if="generalCtrl.editData.enable_login_attempt == true"> 
                        <input type="text" 
                              class="lw-form-field form-control"
                              name="recaptcha_secret_key"
                              ng-required="true" 
                              ng-model="generalCtrl.editData.recaptcha_secret_key" />
                    </lw-form-field>
                    <!-- Google Recaptcha Secret Key -->
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="col">
                 <!-- Enable LivelyWorks Credit Info -->
                <lw-form-checkbox-field field-for="enable_credit_info" label="<?= __tr( 'Enable Credit Info' ) ?>" advance="true">
                    <input type="checkbox" 
                        class="lw-form-field js-switch"
                        name="enable_credit_info"
                        ng-model="generalCtrl.editData.enable_credit_info"
                        ui-switch="" />
                </lw-form-checkbox-field>
                <!-- /Enable LivelyWorks Credit Info -->
            </div>
            ...
            <div class="col">
                <lw-form-checkbox-field field-for="restrict_user_email_update" label="<?= __tr( 'Restrict Users From Updating Email' ) ?>">
                    <input type="checkbox" 
                        class="lw-form-field js-switch"
                        name="restrict_user_email_update"
                        ng-model="generalCtrl.editData.restrict_user_email_update"
                        ui-switch="" />
                </lw-form-checkbox-field>
            </div>
        </div>

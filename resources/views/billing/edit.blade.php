                                ...
                                <tbody  class="lw-selectize-parent">
                                    <tr ng-repeat="(index, productCombination) in billingEditCtrl.billingData.productCombinations" class="lw-combination-row-[[index]]">
                                        ...
                                        <td align="right" class="lw-middile-align">
                                            ...
                                            <button type="button" ng-if="billingEditCtrl.billingData.productCombinations.length == 1" class="btn btn-outline-secondary btn-sm lw-billing-remove-btn"><i class="fa fa-remove"></i></button>

                                            <button type="button" ng-if="billingEditCtrl.billingData.productCombinations.length > 1" class="btn btn-outline-secondary btn-sm lw-billing-remove-btn" ng-click="billingEditCtrl.removeItem(index, productCombination.stock_transaction_uid)"><i class="fa fa-remove"></i></button>
                                        </td>

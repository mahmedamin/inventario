                ...
                <tbody>
                    <tr>
                        ...
                        <td width="70%" align="right">
                            ...
                            <strong>Bill No:</strong> <?= $billData['updateData']['bill_number'] ?><br>
                            <strong>Bill Date:</strong> <?= $billData['updateData']['bill_date'] ?><br>
                            <strong>Due Date:</strong> <?= $billData['updateData']['due_date'] ?><br>
                            @if(isset($billData['updateData']['txn_id']) and !__isEmpty($billData['updateData']['txn_id']))
                            	<strong>Txn:</strong> <?= $billData['updateData']['txn_id'] ?><br>
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="center-justified">
                                ...
                                Bill Amount: <?= $billData['updateData']['formattedTotalAmount'] ?>
                            </div>
                        </td>
                    </tr>
                </tbody>
                    ...
                    @foreach($billData['updateData']['productCombinations'] as $product)
                        <tr class="border-right lw-row-text-font">
                            <td class="pad-left border-top">
                                ...
                                Combination: <?= $product['combination']['combinationTitle'] ?><br>
                            </td>

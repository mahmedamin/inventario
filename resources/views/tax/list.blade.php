...
?><div>
    <div class="lw-section-heading-block">
        ...
        <h3 class="lw-section-heading">
        	...
        	<div class="lw-heading">
        		<a  ui-sref="tax_preset" title="<?= __tr('Manage Tax Presets') ?>" ><?= __tr('Manage Tax Presets') ?></a> &raquo;
                <?= __tr('Tax') ?>
            </div>
        </h3>
        ...
        <div class="lw-section-right-content">
            <a ng-if="canAccess('manage.tax.write.create')" href title="<?= __tr('Add New Tax') ?>" class="lw-btn btn btn-sm btn-primary pull-right" ng-click="taxListCtrl.openAddDialog()">
            <i class="fa fa-plus"></i> <?= __tr('Add New Tax') ?> </a>
        </div>
        <!--/ button -->
    ...
    <table class="table table-striped table-bordered" id="lwTaxList" class="ui celled table" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th><?= __tr('Title') ?></th>
                <th><?= __tr('Type') ?></th>
                <th><?= __tr('Status') ?></th>
                <th><?= __tr('Amount/Rate') ?></th>
                <th><?= __tr('Action') ?></th>
            </tr>
        </thead>
        <tbody></tbody>

...
class InventoryEngine extends BaseEngine implements InventoryEngineInterface
{
    ...
    /**
     * @var  InventoryRepository $inventoryRepository - Inventory Repository
     */
    protected $inventoryRepository;

    /**
     * @var  LocationRepository $locationRepository - Location Repository
     */
    ...
    /**
     * @var  SuppliersRepository $suppliersRepository - Suppliers Repository
     */
    protected $suppliersRepository;

    /**
     * @var  CustomerRepository $customerRepository - Customer Repository
     */
    ...
    public function calculateQuantityByType($stockTransactions)
    {
        ...
        if (!__isEmpty($stockTransactions)) {
            ...
            foreach ($stockTransactions as $key => $stockTransaction) {
                ...
                } else if ($stockTransaction['type'] == 2) {

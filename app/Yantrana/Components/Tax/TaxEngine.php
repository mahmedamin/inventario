...
class TaxEngine extends BaseEngine implements TaxEngineInterface
{
	...
	/**
	 * @var  TaxRepository $taxRepository - Tax Repository
	 */
	protected $taxRepository;

	/**
	 * @var  TaxPresetRepository $taxPresetRepository - TaxPreset Repository
	 */
	...
	function __construct(TaxRepository $taxRepository, TaxPresetRepository $taxPresetRepository)
	{
